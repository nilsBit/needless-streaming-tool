...
const translations = {
  ...
  'settings.change_client_id': { de: 'Client-ID aendern', en: 'Change Client ID' },
  ...
  'settings.change_token': { de: 'Token aendern', en: 'Change token' },
  ...
  'settings.change_db': { de: 'Database aendern', en: 'Change database' },
  ...
  'settings.obs_change': { de: 'Config aendern', en: 'Change config' },
  ...
  'onboarding.welcome_text': { de: 'Dein Stream Toolkit fuer GameDev Streaming. Hier steuerst du alles — Overlays, Experiments, Bugs, Clips, Milestones und mehr.', en: 'Your Stream Toolkit for GameDev Streaming. Control everything here — overlays, experiments, bugs, clips, milestones and more.' },
  ...
  'onboarding.skip': { de: 'Ueberspringen', en: 'Skip' },
  ...
  'twitch.step1': { de: 'Oeffne dev.twitch.tv in deinem Browser und logge dich mit deinem Twitch-Account ein', en: 'Open dev.twitch.tv in your browser and log in with your Twitch account' },
  ...
  'twitch.step3': { de: 'Klicke auf "Register Your Application" und fuege folgende Daten ein:', en: 'Click "Register Your Application" and fill in the following:' },
  'twitch.step4': { de: 'Klicke auf "Create", dann auf "Manage" bei deiner neuen App', en: 'Click "Create", then "Manage" on your new app' },
  'twitch.step5': { de: 'Kopiere die "Client ID" und fuege sie hier ein:', en: 'Copy the "Client ID" and paste it here:' },
  'twitch.name_hint': { de: 'Stream Toolkit (oder beliebig)', en: 'Stream Toolkit (or anything)' },
  'twitch.category': { de: 'Chat Bot', en: 'Chat Bot' },
  'twitch.client_id_placeholder': { de: 'Client-ID hier einfuegen...', en: 'Paste Client ID here...' },
  'twitch.client_id_saved': { de: 'Client-ID gespeichert', en: 'Client ID saved' },
  'twitch.connect_desc': { de: 'Klicke jetzt auf den Button — es oeffnet sich ein Twitch-Login in deinem Browser. Erlaube den Zugriff und du wirst automatisch verbunden.', en: 'Click the button — a Twitch login will open in your browser. Allow access and you\'ll be connected automatically.' },
  ...
  'obs.desc': { de: 'Das Toolkit steuert OBS ueber eine WebSocket-Verbindung. Du musst diese einmal in OBS aktivieren.', en: 'The toolkit controls OBS via a WebSocket connection. You need to enable it once in OBS.' },
  'obs.step1': { de: 'Oeffne OBS Studio', en: 'Open OBS Studio' },
  'obs.step2': { de: 'Gehe oben im Menue auf Tools (oder Werkzeuge) → WebSocket Server Settings', en: 'Go to Tools → WebSocket Server Settings in the menu' },
  ...
  'notion.desc': { de: 'Wenn du Notion nutzt, kannst du deine Clips automatisch dorthin syncen. Falls nicht, ueberspringe diesen Schritt.', en: 'If you use Notion, you can auto-sync your clips there. If not, skip this step.' },
  'notion.step1': { de: 'Oeffne notion.so/my-integrations in deinem Browser', en: 'Open notion.so/my-integrations in your browser' },
  ...
  'notion.step3': { de: 'Kopiere den "Internal Integration Secret" (faengt mit ntn_ an) und fuege ihn hier ein:', en: 'Copy the "Internal Integration Secret" (starts with ntn_) and paste it here:' },
  'notion.token_saved': { de: 'Notion-Token gespeichert', en: 'Notion token saved' },
  'notion.step4': { de: 'Erstelle in Notion eine Datenbank fuer deine Clips (oder nutze eine bestehende)', en: 'Create a database in Notion for your clips (or use an existing one)' },
  'notion.step5': { de: 'Klicke in der Datenbank oben rechts auf "..." → "Add connections" → waehle deine Integration aus', en: 'Click "..." in the top right of the database → "Add connections" → select your integration' },
  'notion.step6': { de: 'Kopiere die Datenbank-URL aus der Browser-Adressleiste und fuege sie hier ein:', en: 'Copy the database URL from the browser address bar and paste it here:' },
  ...
  'overlays.desc': { de: 'Overlays sind die Anzeigen die deine Zuschauer im Stream sehen — Todos, Progress, Alerts und mehr. So fuegest du sie in OBS ein:', en: 'Overlays are the displays your viewers see in the stream — todos, progress, alerts and more. Here\'s how to add them in OBS:' },
  'overlays.step1': { de: 'In OBS: Klicke bei Quellen auf "+" → waehle "Browser"', en: 'In OBS: Click "+" in Sources → select "Browser"' },
  'overlays.step2': { de: 'Gib einen Namen ein (z.B. "Todos Overlay") und klicke "OK"', en: 'Enter a name (e.g. "Todos Overlay") and click "OK"' },
  'overlays.step3': { de: 'Kopiere eine URL von unten und fuege sie im Feld "URL" ein', en: 'Copy a URL from below and paste it in the "URL" field' },
  'overlays.step4': { de: 'Passe Breite (z.B. 400) und Hoehe (z.B. 600) an und klicke "OK"', en: 'Adjust width (e.g. 400) and height (e.g. 600) and click "OK"' },
  'overlays.available': { de: 'Verfuegbare Overlays — klicke auf "URL kopieren" und fuege sie in OBS ein:', en: 'Available overlays — click "Copy URL" and paste into OBS:' },
  'overlays.copy_url': { de: 'URL kopieren', en: 'Copy URL' },
  'overlays.copied': { de: 'Kopiert!', en: 'Copied!' },
  'overlays.hint': { de: 'Du musst nicht alle Overlays jetzt einrichten — du kannst das jederzeit spaeter unter Settings → Overlays machen.', en: 'You don\'t need to set up all overlays now — you can do this anytime later under Settings → Overlays.' },

  // StreamDeck Step
  'streamdeck.title': { de: 'Stream Deck (optional)', en: 'Stream Deck (optional)' },
  'streamdeck.desc': { de: 'Mit dem Stream Deck Plugin kannst du Buttons fuer Szenen-Wechsel, Clips, Bugs, Experiments und mehr direkt auf dein Deck legen.', en: 'With the Stream Deck plugin you can put buttons for scene switching, clips, bugs, experiments and more directly on your deck.' },
  ...
  'streamdeck.step3': { de: 'Kopiere den Token und fuege ihn im Button-Settings unter "API Token" ein (einmalig):', en: 'Copy the token and paste it in the button settings under "API Token" (one time only):' },
  ...
  'done.warning': { de: 'Twitch und OBS muessen verbunden sein. Gehe zurueck und richte sie ein.', en: 'Twitch and OBS must be connected. Go back and set them up.' },
  'done.hint': { de: 'Du kannst alles jederzeit in den Settings aendern oder den Wizard unter Settings erneut starten.', en: 'You can change everything anytime in Settings or restart the wizard from Settings.' },

  // Overlays Panel
  'overlays_panel.title': { de: 'Overlays', en: 'Overlays' },
  'overlays_panel.desc': { de: 'Overlay-URLs fuer OBS Browser Source. Overlays anpassen oder eigene erstellen.', en: 'Overlay URLs for OBS Browser Source. Customize or create your own.' },
  ...
  'help.desc': { de: 'Alles was du ueber das Stream Toolkit wissen musst.', en: 'Everything you need to know about the Stream Toolkit.' },
} as const;
