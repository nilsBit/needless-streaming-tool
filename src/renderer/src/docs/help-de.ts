...
**Aus Figma:** Sendest du im Figma-Plugin einen Frame, übernimmt das Toolkit sofort, was eindeutig ist — Palette, Textfarbe, Schriftgröße und -schnitt, Rahmen, Ecken, Deckkraft — und die Overlays zeigen es live. Was mehr verlangt (Verschieben, Größen, neue Ebenen, deine Wünsche aus der Notiz), wartet unter Settings → Overlays → **Figma**, bis es in einer Claude-Sitzung umgesetzt wird; der Reiter zeigt, wie viel offen ist. Dort lässt sich jede übernommene Änderung auch zurücknehmen.
